      ...
      <div className="container" style={{ paddingBottom: '4rem', paddingTop: '6rem' }}>
         ...
         <section className="section hero-section" style={{ textAlign: 'left', alignItems: 'flex-start', display: 'flex', flexDirection: 'column' }}>
            ...
            <div className="hero-meta" style={{ justifyContent: 'flex-start', flexWrap: 'wrap', gap: '1.5rem', marginTop: '1.5rem' }}>
               ...
               <a href="https://www.linkedin.com/in/mashroof-mashru/" target="_blank" rel="noreferrer" style={{ color: 'var(--text-muted)', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '0.5rem' }}><Linkedin size={18} /> LinkedIn</a>
               <a href="https://github.com/mashroofmashru" target="_blank" rel="noreferrer" style={{ color: 'var(--text-muted)', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '0.5rem' }}><Github size={18} /> GitHub</a>
            </div>
         </section>
